...
for test_img_number in range(255):
    ...
    for chosen_crop_types_list in chosen_crop_types_list_list:
        ...
        del input_mask_1
        gc.collect()
        my_model_1 = load_model('/home/luser/stelar_3d/storage/saved_model/3D_unet_res_labels_'+vista_crop_dict[chosen_crop_types_list[0]]+'_'+vista_crop_dict[chosen_crop_types_list[1]]+'_'+vista_crop_dict[chosen_crop_types_list[2]]+'_num_epocs_'+str(num_epochs)+'.h5', compile=False)
